...
noremap  <silent> gc :call CommentLine()<CR>
" key-mappings for range comment lines in visual <Shift-V> mode
vnoremap <silent> gc :call RangeCommentLine()<CR>

" key-mappings for un-comment line in normal mode
noremap  <silent> gx :call UnCommentLine()<CR>
" key-mappings for range un-comment lines in visual <Shift-V> mode
vnoremap <silent> gx :call RangeUnCommentLine()<CR>
...
function! CommentLine()
  ...
  elseif file_name =~ '\.sql$'
    execute ":silent! normal ^i--\<ESC>\<down>^"
  " for .ksh or .sh or .csh or .pl or .pm or .py files use #
