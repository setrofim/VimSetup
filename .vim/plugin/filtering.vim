...
" nnoremap ,F :call Gather(@/, 0)<CR>:echo<CR>
 nnoremap ,F :call Gather(expand("<cword>"), 0)<CR>:echo<CR>
...
function! DefaultFilterWindowEntered()
    ...
    nnoremap <buffer> <S-CR> :call GotoLineInOriginal(0)<CR>:echo<CR>
    nnoremap <buffer> <CR> :call GotoLineInOriginal(1)<CR>:echo<CR>
